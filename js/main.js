...
//StrapToggle
isTrue = true;
$(".strap-toggle-menu").click(function () {
    if (isTrue == true) {
        ...
        $(".fa-align-justify").toggleClass("fa-times");
        $(".nav-tab-menu li").animate({ opacity: "0", paddingTop: "500px" }, 1200);
    }
});
...
$(".nav-item a").click(async (e) => {
    ...
    if (listBy == "search") {
        ...
        <div class="col-md-6 rounded">
                    <div>
                        <input id="letter" class="form-control mb-2 bg-transparent text-white" type="text"
                            placeholder="Search By First Latter">
                    </div>
        </div>
                <div class="col-md-6 rounded mb-3 ">
                    <div>
                        <input id="searchInput" class="form-control bg-transparent text-white" type="text"
    ...
    document.querySelector('.strap-toggle-menu').dispatchEvent(click_event);
...
function displayCategories() {
    ...
    <div class="meal shadow rounded position-relative">
            <div onclick="filterByCategory('${arr[i].strCategory}')">
                <img src='${arr[i].strCategoryThumb}' class="w-100 rounded materials">
                <div class="layer d-flex align-items-center">
                    <div class="info p-2 materials">
...
function displayIngredients() {
    let e = ""
    for (let i = 0; i < arr.length; i++) e += `
    <div class="col-md-6 col-lg-3 pt-4 shadow">
        <div onclick="getMainIngredient('${arr[i].strIngredient}')" class="meal rounded position-relative">
            <div class="materials">
...
function displayArea() {
    ...
    <div class="col-md-6 col-lg-3 my-3 shadow materials">
        <div class="meal position-relative pt-3">
...
function displayMeals(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        meals += `<div class="col-md-6 col-lg-3 my-3">
        <div class="meal rounded position-relative" onclick="getMeal('${arr[i].idMeal}')">
            <div>
                <img src="${arr[i].strMealThumb}" class="w-100 rounded materials">
                <div class="layer d-flex align-items-center materials">
                    <div class="info p-2">
                        <h2>${arr[i].strMeal}</h2>
                    </div>
                </div>
...
function displayMeal(meal) {
    ...
    for (let i = 1; i <= 20; i++) {
        if (meal[`strIngredient${i}`]) {
            recipes += `<li class="my-3 mx-1 p-1 alert alert-success rounded text-center">${meal[`strMeasure${i}`]} ${meal[`strIngredient${i}`]}</li>`
        }
    }
    ...
    <div class="col-md-4 text-white">
				...
				<div class="col-md-8 text-white">
					...
					<ul class="d-flex list-unstyled flex-wrap alert-success" id="recipes">
					</ul>

					<h3 class="my-2 mx-1 p-1 text-start"><strong>Tags :<strong></h3>
...
function userPasswordValid() {
    return /^[a-zA-Z0-9!@#$%^&*]{6,16}$/.test(userPassword.value)
}
